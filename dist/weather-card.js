 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Nt(t,e){return t.states[e]}function Ot(t){return t.state}function Ht(t,e){return t.config.unit_system[e]}const Pt="sun.sun";var Ut,Rt;(Rt=Ut||(Ut={})).AboveHorizon="above_horizon",Rt.BelowHorizon="below_horizon";var Ft,jt,Xt=Y`
  :root {
    --color-warn: #fffbe5;
  }
  .flex {
...
`;function Qt(t,e){switch(t){case Ft.Clear:case Ft.Sunny:return e===Ut.BelowHorizon?Zt:Gt;case Ft.ClearNight:return Zt;case Ft.Cloudy:case Ft.Fog:case Ft.Windy:return Bt;case Ft.Hail:case Ft.SnowyRainy:return Jt;case Ft.Lightning:case Ft.LightningRainy:return Kt;case Ft.PartlyCloudy:case Ft.WindyVariant:return e===Ut.BelowHorizon?Lt:It;case Ft.Pouring:return Vt;case Ft.Rainy:return Wt;case Ft.Snowy:return qt}}(jt=Ft||(Ft={})).Clear="clear",jt.ClearNight="clear-night",jt.Cloudy="cloudy",jt.Fog="fog",jt.Hail="hail",jt.Lightning="lightning",jt.LightningRainy="lightning-rainy",jt.PartlyCloudy="partlycloudy",jt.Pouring="pouring",jt.Rainy="rainy",jt.Snowy="snowy",jt.SnowyRainy="snowy-rainy",jt.Sunny="sunny",jt.Windy="windy",jt.WindyVariant="windy-variant";const te="weather";var ee=function(t,e,n,a){var i,r=arguments.length,o=r<3?e:null===a?a=Object.getOwnPropertyDescriptor(e,n):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,n,a);else for(var s=t.length-1;s>=0;s--)(i=t[s])&&(o=(r<3?i(o):r>3?i(e,n,o):i(e,n))||o);return r>3&&o&&Object.defineProperty(e,n,o),o};let ne=class extends zt{static get styles(){return Y`
    ...
    `}handleChange(t){return e=>{var n;const a=this.config;if(null==a||null==this.hass)return;const i=e.target;if(null==i)return;const r=Object.assign({},a),o=null!==(n=i.checked)&&void 0!==n?n:i.value;"string"==typeof o&&""===o?delete r[t]:r[t]=o,z(this,"config-changed",{config:r})}}};ee([Yt()],ne.prototype,"config",void 0),ee([Tt()],ne.prototype,"hass",void 0),ne=ee([Ct("weather-card-editor")],ne);var ae,ie=function(t,e,n,a){var i,r=arguments.length,o=r<3?e:null===a?a=Object.getOwnPropertyDescriptor(e,n):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(t,e,n,a);else for(var s=t.length-1;s>=0;s--)(i=t[s])&&(o=(r<3?i(o):r>3?i(e,n,o):i(e,n))||o);return r>3&&o&&Object.defineProperty(e,n,o),o};const re="weather-card";let oe=class extends zt{static getStubConfig(t,e,n){let a=e.find((t=>E(t)===te));return a||(a=n.find((t=>E(t)===te))),{entity:a}}static async getConfigElement(){return document.createElement("weather-card-editor")}setConfig(t){if(!t.entity)throw new Error("Please define a weather entity");this.config=t}shouldUpdate(t){return function(t,e,n){if(e.has("config")||n)return!0;if(t.config.entity){var a=e.get("hass");return!a||a.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!1)}render(){const t=this.config.entity,e=Nt(this.hass,t);return e?lt`<ha-card class="container" @click=${this.handleClick}>
      ${this.renderCurrent(e)} ${this.renderForecasts(e)}
    </ha-card>`:lt`
        <ha-card>
          <div class="not-found">Entity not available: ${t}</div>
        </ha-card>
      `}renderCurrent(t){const{current:e,name:n}=this.config,{attributes:{temperature:a}}=t,i=Ot(Nt(this.hass,Pt)),r=Ot(t),o=this.getUnit("temperature");return!1===e?lt``:lt`<div class="grid grid-align-center current">
      ...
      <div class="flex flex-column right-content">
        <div class="flex">
          <span class="temperature">${a}</span>
          <span class="unit">${o}</span>
        </div>
        <div class="flex flex-align-center secondary-text">
          <ha-icon icon="mdi:water-percent"></ha-icon>
          ${t.attributes.humidity}<span> % </span>
        </div>
      </div>
    </div>`;var s}renderForecasts(t){const{forecast:e=!1,number_of_forecasts:n=5,hourly_forecast:a}=this.config;if(!e)return lt``;const i=this.hass,{locale:r}=i,{attributes:{next_dawn:o,next_dusk:s}}=Nt(i,Pt),{language:l="en"}=null!=r?r:{},m=a?{hour:"2-digit",minute:"2-digit"}:{weekday:"short"},{attributes:{forecast:c}}=t,f=c.slice(0,n).map((({condition:t,datetime:e,temperature:n,templow:i})=>{const r=new Date(e);return lt`<div class="flex flex-column forecast">
          <div>${r.toLocaleString(l,m)}</div>
          <div class="flex-no-shrink icon-small">
            ${Qt(t,a?r>=new Date(s)&&r<new Date(o)?Ut.BelowHorizon:Ut.AboveHorizon:null)}
          </div>
          <span class="temp-high">${n}°</span>
          <span class="temp-low secondary-text">${i}°</span>
        </div>`}));return lt` <div class="flex forecasts">${f}</div> `}handleClick(){z(this,"hass-more-info",{entityId:this.config.entity})}getUnit(t){const e=this.hass,n="km"===Ht(e,"length");switch(t){case"air_pressure":return n?"hPa":"inHg";case"precipitation":return n?"mm":"in";case"precipitation_probability":return"%";default:return Ht(e,t)}}};oe.styles=Xt,ie([Yt()],oe.prototype,"config",void 0),ie([Tt()],oe.prototype,"hass",void 0),oe=ie([Ct(re)],oe),window.customCards=null!==(ae=window.customCards)&&void 0!==ae?ae:[],window.customCards.push({type:re,name:"Weather Card",description:"A custom weather card with animated icons"})})();